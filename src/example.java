...
public class example {
	...
	public static void queryTest() throws IOException, ParseException{
		...
		printDocInfo(search, search.termQuery("contents", "Å£¶Ù", 100));
		
		System.out.println("--------------------booleanQuery-----------------");
		printDocInfo(search, search.booleanQuery(100, new BooleanQueryClause[]{new BooleanQueryClause("contents", "Å£¶Ù", Occur.MUST),
				new BooleanQueryClause("contents", "À®°È", Occur.MUST_NOT)}));
		
		System.out.println("--------------------fuzzyQuery-----------------");
		printDocInfo(search, search.fuzzyQuery("contents", "Å£¶Ù", 100,1));
		
		System.out.println("--------------------regexpQuery-----------------");
		printDocInfo(search, search.regexpQuery("contents", "Å£.*", 100));
		
		System.out.println("--------------------prefixQuery-----------------");
		printDocInfo(search, search.prefixQuery("contents", "Å£", 100));
		
		System.out.println("--------------------phraseQuery-----------------");
		printDocInfo(search, search.phraseQuery("contents", new String[]{"Å£¶Ù", "À®°È","Ôç³¿"}, 100, 100));
		
		System.out.println("--------------------multiphraseQuery-----------------");
		printDocInfo(search, search.multiPhraseQuery("contents", new String[]{"Å£¶Ù","À®°È","Ôç³¿"}, 100,100));
...
//		search.addTermRangeFilter("", lowerTerm, upperTerm, includeLower, includeUpper);
		...
		System.out.println("--------------------termQuery using addNumericRangeFilter-----------------");
		search.clearFilter();
		printDocInfo(search, search.regexpQuery("contents", "µØ.*", 100));
